...
import { isVeg, getDietaryLabel } from "@/lib/menu-utils";
import { CATEGORY_LABELS, CATEGORY_EMOJIS } from "@/config/menu-display";
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 relative z-10">
        ...
        <div ref={ref} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
          {featuredItems.slice(0, 6).map((item, i) => {
            ...
            const dietaryLabel = getDietaryLabel(item.tags);
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className={`text-[9px] uppercase tracking-wider font-medium ${
                            vegStatus ? "text-green-600" : "text-red-600"
                          }`}>
                            {dietaryLabel}
                          </span>
                        </div>
